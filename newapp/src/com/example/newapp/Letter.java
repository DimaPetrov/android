...
ModImageView[] collect;
	...
	public void ColorObj()
	{
		...
		collect[0].image = (R.drawable.o_album_en); collect[0].color = "Альбом";
		collect[1].image = (R.drawable.o_bed_en); collect[1].color = "Кровать";
		collect[2].image = (R.drawable.o_chair_en); collect[2].color = "Стул";
		collect[3].image = (R.drawable.o_cup_en); collect[3].color = "Кружка";
		collect[4].image = (R.drawable.o_doll_en); collect[4].color = "Кукла";
		collect[5].image = (R.drawable.o_fork_en); collect[5].color = "Вилка";
		collect[6].image = (R.drawable.o_gloves_en); collect[6].color = "Перчатки";
		collect[7].image = (R.drawable.o_lamp_en); collect[7].color = "Лампа";
		collect[8].image = (R.drawable.o_laptop_en); collect[8].color = "Ноутбук";
		collect[9].image = (R.drawable.o_pants_en); collect[9].color = "Трусы";
		collect[10].image = (R.drawable.o_phone_en); collect[10].color = "Телефон";
		collect[11].image = (R.drawable.o_plate_en); collect[11].color = "Тарелка";
		collect[12].image = (R.drawable.o_scissors_en); collect[12].color = "Ножницы";
		collect[13].image = (R.drawable.o_socks_en); collect[13].color = "Носки";
		collect[14].image = (R.drawable.o_spoon_en); collect[14].color = "Ложка";
	...
	public void startGame()
	{
		...
		GameSpace.setHeader("Выбери предмет на букву '"+collect[rand].color.charAt(0)+"'");
		int y = r.nextInt(3);
		int instx = 200;
		int insty = 100;
		for (int i =0; i<3; i++)
