...
public class Size extends GameSpace{
	...
	public void startGame()
	{
        ...
        smallParams.width = (int) (110*d);
        smallParams.height = (int) (110*d * 1.22);
        mediumParams.width = (int) (110*d * 1.25);
        mediumParams.height = (int) (110*d * 1.19 * 1.25);
        bigParams.width = (int) (110*d*1.6);
        bigParams.height = (int) (110*d * 1.16 * 1.6);
        
        Display disp = cont.getWindowManager().getDefaultDisplay();
        bigParams.leftMargin = (int) (disp.getWidth()-bigParams.width-20*d);
        bigParams.topMargin = (int) (70*d);
        mediumParams.leftMargin = (int) (bigParams.leftMargin-mediumParams.width-10*d);
        mediumParams.topMargin = bigParams.topMargin+bigParams.height-mediumParams.height;
        smallParams.leftMargin = (int) (mediumParams.leftMargin-smallParams.width-10*d);
        smallParams.topMargin = mediumParams.topMargin+mediumParams.height-smallParams.height;
        
        
        boxParam[0].width =  (int) (smallParams.width-24*d);
        boxParam[0].height = (int) (smallParams.width-24*d);
        boxParam[1].width = (int) (mediumParams.width-26*d);
        boxParam[1].height = (int) (mediumParams.width-26*d);
        boxParam[2].width = (int) (bigParams.width-32*d);
        boxParam[2].height = (int) (bigParams.width-32*d);
        boxParam[0].leftMargin = (int) (smallParams.leftMargin+7*d);
        boxParam[0].topMargin = (int) ( (smallParams.topMargin + 0.22*smallParams.height)+3*d);
        boxParam[1].leftMargin = (int) (mediumParams.leftMargin+8*d);
        boxParam[1].topMargin = (int) (mediumParams.topMargin + 0.19*mediumParams.height+3*d);
        boxParam[2].leftMargin = (int) (bigParams.leftMargin+8*d);
        boxParam[2].topMargin = (int) (bigParams.topMargin + 0.16*bigParams.height+7*d);
        ...
        objParam[0].topMargin = (int) (smallParams.topMargin+smallParams.height+10*d);
        objParam[1].leftMargin = boxParam[2].leftMargin;
        objParam[1].topMargin = (int) (smallParams.topMargin+smallParams.height+10*d);
        objParam[2].leftMargin = (int) (boxParam[0].leftMargin-20*d);
        objParam[2].topMargin = (int) (smallParams.topMargin+smallParams.height+10*d);
